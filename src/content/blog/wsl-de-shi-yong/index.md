...
1.   在<https://learn.microsoft.com/zh-cn/windows/wsl/install-manual>中找到发行版的下载链接，如图
     ...
     <img src="/images/wsl-de-shi-yong/image-20241027142019943.png" alt="image-20241027142019943" style="zoom:50%;" />

2.   选择需要安装的发行版，这里以Kali Linux为例，下载完成后解压，得到如图文件夹

     <img src="/images/wsl-de-shi-yong/image-20241027142516252.png" alt="image-20241027142516252" style="zoom:50%;" />

3.   选择合适的版本，我选择的是`x64`，将后缀改为`.zip`，解压，得到如图文件夹

     <img src="/images/wsl-de-shi-yong/image-20241027142648245.png" alt="image-20241027142648245" style="zoom:50%;" />
